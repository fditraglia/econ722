...
The scaling is, of course, arbitrary but this particular choice is traditional.
...
To see why this is the case, we employ two second-order Taylor Expansions. First,
\begin{eqnarray*}
	\int g(y) \log f(y|\widehat{\theta}) dy &=& \int g(y) \log f(y|\theta_0) \; dy \\
	&&+ \;\int g(y) \frac{\partial \log f(y|\theta_0)}{\partial \theta}\; dy \\
		&& + \; 
\end{eqnarray*}

% 
>>>>>>> parent of c11d6ad... finished everything except the derivation of the bias expansion
...
\end{eqnarray*}
Substituting this back into the expression for $B$ gives
\begin{eqnarray*}

...
public fditraglia / econ722

econ722 / lecture05_focused_selection.tex
Francis DiTraglia fditraglia 15 hours ago
that's all for tonight!

1 contributor
file 758 lines (694 sloc) 59.57 kb
...
\paragraph{The FIC}
We could really just stop here, but in the paper Claeskens and Hjort express the FIC in a slightly different (and simpler) way by removing constants that do not vary across models. First they construct the \emph{limit experiment} version of the AMSE by substituting $DD' - K$ for $\delta\delta'$. This yields
\begin{eqnarray*}
...
This formula may look somewhat complicated, but calculating it only requires quantities that we get automatically from fitting the full model. Thus, the FIC does \emph{not} require us to fit each of the candidate models.

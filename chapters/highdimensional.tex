...
In Econ 705 you learned that ordinary least squares (OLS) is the minimum variance unbiased linear estimator of $\beta$ under the assumptions $E[\boldsymbol{\epsilon}|X] = \mathbf{0}$ and $Var(\mathbf{\epsilon}|X) = \sigma^2 I$.
...
\end{eqnarray*}
Since $X'X \sim \chi^2(p)$, $E[1/(X'X)]$ exists and is positive whenever $p \geq 3$.
And since $(p-2)^2$ is always positive, the second term in the MSE expression is \emph{negative}

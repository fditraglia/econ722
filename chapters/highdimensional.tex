...
The SVD allows us to express \emph{any} $m \times n$ matrix $A$ of arbitrary rank $r$ according to 
	...
	\begin{itemize}
      ...
      (In other words, some of the eigenvalues are zero, but the rest are positive: these are the singular values.)
	 \end{itemize} 
...
The number of singular values equals $r$, the rank of $A$, which is at most $\min\{m,n\}$.

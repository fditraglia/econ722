...
\caltextnext{Model Selection I: AIC, TIC, AIC$_c$, Mallow's $C_p$ \shadowbox{Problem \#1 (Di)}}
\caltextnext{Model Selection II: BIC, Cross-validation \shadowbox{Problem \# 3 (Zijun)}}
\caltextnext{Model Selection III: Asymptotic Properties, Consistent vs.\ Efficient Model Selection \shadowbox{Problem \#10 (Ryan)}}
\caltextnext{Moment Selection I: Consistent Moment Selection \shadowbox{Problem \#5 (Collum)}}
\caltextnext{Presentation Workshop -- \textbf{(2pm Start time!)}}
\caltextnext{Moment Selection II: Focused Moment Selection and Averaging, Inference \\\shadowbox{Problem \#2 (Hongye)}} 
\caltextnext{High-Dimensional Regression I: QR and SV Decompositions, PCA, Ridge Regression \shadowbox{Problem \#11 (Agustin)}}
\caltextnext{High-Dimensional Regression II: LASSO, PCR \shadowbox{Problem \#8 (Xiaoliang)}}
\caltextnext{High-Dimensional Regression III \shadowbox{Problem \# 12 (Boyuan)}}
\caltextnext{Selective Inference}
\caltextnext{Presentations: Boyuan, Agustin, Ryan, Hongye}
\caltextnext{Presentations: Zijun, Di, Xiaoliang, Collum}
% ... and so on

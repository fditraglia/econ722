...
\paragraph{Problems With Andrews Approach}
First, we don't usually care about finding the true MCs. Bias-variance tradeoff, allow slightly incorrect MC to bring down variance. Second, the issue of irrelevant moment conditions. Briefly mention the Hall \& Peixe paper.

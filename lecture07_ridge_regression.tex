...
To understand what follows, we'll need a concept from decision theory called \emph{admissibility}. We say that an estimator $\widehat{\theta}$ of some parameter $\theta$ is \textbf{admissible} if there
